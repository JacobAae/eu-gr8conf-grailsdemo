...
@Rollback
@Stepwise
class AttendeeUglyFunctionalSpec extends GebSpec {
    ...
    void "Submit form with no errors"() {
        ...
        $('span.property-value').find{ it.text() == 'bobby@somemail.com'}
    }
    ...
    void "Update Attendee"() {
        ...
        $('span.property-value').find{ it.text() == 'alison@somemail.com'}
    }
